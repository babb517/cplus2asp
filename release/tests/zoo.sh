...
# --------------------------- Test 1 ---------------------------
echo "% --------------------------- Test 1 ---------------------------" 
echo "$ cplus2asp domains/zoo-no-macros/zoo-test1.cp query=0 --shift" 
cplus2asp domains/zoo-no-macros/zoo-test1.cp query=0 --shift
...
echo "$ cplus2asp domains/zoo-no-macros/zoo-test2.cp query=0 --shift" 
cplus2asp domains/zoo-no-macros/zoo-test2.cp query=0 --shift
...
echo "$ cplus2asp domains/zoo-no-macros/zoo-test3.cp query=0 --shift" 
cplus2asp domains/zoo-no-macros/zoo-test3.cp query=0 --shift
...
echo "$ cplus2asp domains/zoo-no-macros/zoo-test4.cp query=0 --shift" 
cplus2asp domains/zoo-no-macros/zoo-test4.cp query=0 --shift
...
echo "$ cplus2asp domains/zoo-no-macros/zoo-test4.cp query=1 --shift" 
cplus2asp domains/zoo-no-macros/zoo-test4.cp query=1 --shift
...
# Solution 1:
# 
# 	0:  pos(homer)=7 pos(jumbo)=3
# 
# 	ACTIONS:  open(homer,gateAO)
# 
# 	1:  opened(gateAO) pos(homer)=7 pos(jumbo)=3
# 
# 	ACTIONS:  move(homer,4) move(jumbo,4)
# 
# 	2:  opened(gateAO) pos(homer)=4 pos(jumbo)=4
# 
# 	ACTIONS:  move(homer,2) move(jumbo,7)
# 
# 	3:  opened(gateAO) pos(homer)=2 pos(jumbo)=7
# 
# 
# Solution 2:
# 
...
echo "$ cplus2asp domains/zoo-no-macros/zoo-test5.cp query=0 --shift" 
cplus2asp domains/zoo-no-macros/zoo-test5.cp query=0 --shift
...
echo "$ cplus2asp domains/zoo-no-macros/zoo-test5.cp query=1 --shift" 
cplus2asp domains/zoo-no-macros/zoo-test5.cp query=1 --shift
...
echo "$ cplus2asp domains/zoo-no-macros/zoo-test5.cp query=2 --shift" 
cplus2asp domains/zoo-no-macros/zoo-test5.cp query=2 --shift
...
echo "$ cplus2asp domains/zoo-no-macros/zoo-test5.cp query=11 --shift" 
cplus2asp domains/zoo-no-macros/zoo-test5.cp query=11 --shift
...
echo "$ cplus2asp domains/zoo-no-macros/zoo-test6.cp query=0 --shift" 
cplus2asp domains/zoo-no-macros/zoo-test6.cp query=0 --shift
