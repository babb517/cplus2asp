/* Generated by re2c 0.13.5 on Wed Oct 23 11:24:38 2013 */
#line 1 "Config.re2c"
/*
...
Config::Config(std::string const& name) {
	...
	mQueries[CONST_QUERY_NONE] = Query("Satisfiability check (no query)", CONST_QUERY_NONE, UNDEFINED, UNDEFINED);
}
