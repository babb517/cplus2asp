/* Generated by re2c 0.13.5 on Wed Apr 10 01:22:31 2013 */
...
/* History:
 * v3.2 - Major revision of command-line arguments. Revised command line calls to provide system portability (almost).
	...
	for(int i = 1; i < argc; i++)
	{
		...
		case OPT_MODE_SELECT:
			...
			if (!strcmp(argv[i],ARG_MODE_STATIC_MANUAL)) {
				...
				error("Expected a mode option (one of '%s', '%s', '%s', or '%s') following option '%s'. Exiting.",true,0,
						ARG_MODE_STATIC_AUTO, ARG_MODE_STATIC_MANUAL, ARG_MODE_INCREMENTAL, OPT_MODE_REACTIVE, (tmpBool) ? argv[i-1] : argv[i]);
				return OPT_STAT_BAD_ARG;
			}
...
yy24:
#line 1691 "cplus2asp.re2c"
		{ return OPT_SHIFT; }
#line 1829 "<stdout>"
yy25:
		++opt;
#line 1678 "cplus2asp.re2c"
...
yy38:
#line 1663 "cplus2asp.re2c"
		{ return OPT_BRIDGE_OUT; }
#line 1891 "<stdout>"
yy39:
		++opt;
#line 1662 "cplus2asp.re2c"
...
yy42:
#line 1661 "cplus2asp.re2c"
		{ return OPT_BRIDGE_OPTS; }
#line 1906 "<stdout>"
yy43:
		++opt;
#line 1660 "cplus2asp.re2c"
...
yy82:
		++opt;
#line 1667 "cplus2asp.re2c"
		{ return OPT_FRM_POST; }
#line 2091 "<stdout>"
yy84:
		++opt;
#line 1666 "cplus2asp.re2c"
		{ return OPT_FRM_PRE; }
#line 2096 "<stdout>"
yy86:
		++opt;
#line 1668 "cplus2asp.re2c"
		{ return OPT_FROM_SO; }
#line 2101 "<stdout>"
yy88:
		yych = *++opt;
...
yy107:
#line 1675 "cplus2asp.re2c"
		{ return OPT_GRD_OUT; }
#line 2199 "<stdout>"
yy108:
		++opt;
#line 1674 "cplus2asp.re2c"
...
yy111:
#line 1673 "cplus2asp.re2c"
		{ return OPT_GRD_OPTS; }
#line 2214 "<stdout>"
yy112:
		++opt;
#line 1672 "cplus2asp.re2c"
...
yy130:
		++opt;
#line 1681 "cplus2asp.re2c"
		{ return OPT_JUST_POST; }
#line 2316 "<stdout>"
yy132:
		++opt;
#line 1680 "cplus2asp.re2c"
		{ return OPT_JUST_PRE; }
#line 2321 "<stdout>"
yy134:
		++opt;
#line 1682 "cplus2asp.re2c"
		{ return OPT_JUST_SO; }
#line 2326 "<stdout>"
yy136:
		yych = *++opt;
...
yy153:
#line 1689 "cplus2asp.re2c"
		{ return OPT_MINSTEP; }
#line 2403 "<stdout>"
yy154:
		++opt;
#line 1688 "cplus2asp.re2c"
...
yy157:
#line 1687 "cplus2asp.re2c"
		{ return OPT_MAXSTEP; }
#line 2418 "<stdout>"
yy158:
		++opt;
#line 1686 "cplus2asp.re2c"
...
yy195:
		++opt;
#line 1677 "cplus2asp.re2c"
		{ val = opt; return OPT_GRINGO_NONE_HACK; }
#line 2590 "<stdout>"
yy197:
		++opt;
#line 1676 "cplus2asp.re2c"
		{ val = opt; return OPT_GRINGO_NONE_HACK; }
#line 2595 "<stdout>"
yy199:
		++opt;
