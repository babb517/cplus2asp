...
echo "$ cplus2asp domains/buying-test query=1  --none-hack $@ > tmp/buying-1" 
cplus2asp domains/buying-test query=0 --none-hack $@ -transout=tmp/buying-1.trans > tmp/buying-1
...
echo "$ cplus2asp domains/buying-test query=2  --none-hack $@ > tmp/buying-2" 
cplus2asp domains/buying-test query=1  --none-hack $@ -transout=tmp/buying-2.trans > tmp/buying-2
...
echo "$ cplus2asp domains/spacecraft-test query=0 0 --none-hack $@ > s" 
cplus2asp domains/spacecraft-test query=0 0 --none-hack $@ -transout=tmp/space-0.trans > tmp/space-0
...
echo "$ cplus2asp domains/mcp-test query=0 --none-hack $@" 
cplus2asp domains/mcp-test query=0 --none-hack $@ -transout=tmp/mcp-0.trans > tmp/mcp-0
...
echo "$ cplus2asp domains/bw-cost-test query=0 --none-hack $@" 
cplus2asp domains/bw-cost-test query=0 --none-hack $@ -transout=tmp/bw-0.trans > tmp/bw-0
